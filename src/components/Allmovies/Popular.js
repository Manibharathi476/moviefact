...
import ExampleNavbar from 'components/Headers/ExamplesNavbar';
...
class Popular extends Component
{
    ...
    render() {
        return(
            ...
            <Movie viewMovieInfo={this.viewMovieInfo} movies={this.state.movies} /> : <div><MovieInfo currentMovie={this.state.currentMovie}/></div>
            } 
            </Fragment>
        );
    }
